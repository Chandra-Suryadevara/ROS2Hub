...
static const _TurnCamera_Request_type_support_symbol_names_t _TurnCamera_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, firstservicepkg, srv, TurnCamera_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, firstservicepkg, srv, TurnCamera_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, firstservicepkg, srv, TurnCamera_Request)() {
  return &::firstservicepkg::srv::rosidl_typesupport_c::TurnCamera_Request_message_type_support_handle;
}
...
static const _TurnCamera_Response_type_support_symbol_names_t _TurnCamera_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, firstservicepkg, srv, TurnCamera_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, firstservicepkg, srv, TurnCamera_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, firstservicepkg, srv, TurnCamera_Response)() {
  return &::firstservicepkg::srv::rosidl_typesupport_c::TurnCamera_Response_message_type_support_handle;
}
...
static const _TurnCamera_type_support_symbol_names_t _TurnCamera_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, firstservicepkg, srv, TurnCamera)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, firstservicepkg, srv, TurnCamera)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, firstservicepkg, srv, TurnCamera)() {
  return &::firstservicepkg::srv::rosidl_typesupport_c::TurnCamera_service_type_support_handle;
}
