...
#include "firstservicepkg/action/detail/navigate__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const firstservicepkg::action::Navigate_Goal & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  firstservicepkg::action::Navigate_Goal & ros_message)
{
  // Member: goal_point
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = firstservicepkg::action::Navigate_Goal;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const firstservicepkg::action::Navigate_Goal *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<firstservicepkg::action::Navigate_Goal *>(
    untyped_ros_message);
...
template<>
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_EXPORT_firstservicepkg
const rosidl_message_type_support_t *
get_message_type_support_handle<firstservicepkg::action::Navigate_Goal>()
{
  return &firstservicepkg::action::typesupport_fastrtps_cpp::_Navigate_Goal__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, firstservicepkg, action, Navigate_Goal)() {
  return &firstservicepkg::action::typesupport_fastrtps_cpp::_Navigate_Goal__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_firstservicepkg
cdr_serialize(
  const firstservicepkg::action::Navigate_Result & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: time_taken
  cdr << ros_message.time_taken;
  return true;
}
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  firstservicepkg::action::Navigate_Result & ros_message)
{
  // Member: time_taken
  cdr >> ros_message.time_taken;
  ...
  size_t current_alignment)
{
  ...
  // Member: time_taken
  {
    size_t item_size = sizeof(ros_message.time_taken);
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = firstservicepkg::action::Navigate_Result;
    is_plain =
      (
      offsetof(DataType, time_taken) +
      last_member_size
      ) == ret_val;
  }
...
{
  auto typed_message =
    static_cast<const firstservicepkg::action::Navigate_Result *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<firstservicepkg::action::Navigate_Result *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &firstservicepkg::action::typesupport_fastrtps_cpp::_Navigate_Result__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, firstservicepkg, action, Navigate_Result)() {
  return &firstservicepkg::action::typesupport_fastrtps_cpp::_Navigate_Result__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_firstservicepkg
cdr_serialize(
  const firstservicepkg::action::Navigate_Feedback & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  firstservicepkg::action::Navigate_Feedback & ros_message)
{
  // Member: distance_to_point
  cdr >> ros_message.distance_to_point;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = firstservicepkg::action::Navigate_Feedback;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const firstservicepkg::action::Navigate_Feedback *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<firstservicepkg::action::Navigate_Feedback *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &firstservicepkg::action::typesupport_fastrtps_cpp::_Navigate_Feedback__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, firstservicepkg, action, Navigate_Feedback)() {
  return &firstservicepkg::action::typesupport_fastrtps_cpp::_Navigate_Feedback__handle;
}
...
// functions for firstservicepkg::action::Navigate_Goal already declared above
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_firstservicepkg
cdr_serialize(
  const firstservicepkg::action::Navigate_SendGoal_Request & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: goal_id
  unique_identifier_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize(
    ...
    cdr);
  // Member: goal
  firstservicepkg::action::typesupport_fastrtps_cpp::cdr_serialize(
    ros_message.goal,
    cdr);
  return true;
}
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  firstservicepkg::action::Navigate_SendGoal_Request & ros_message)
{
  // Member: goal_id
  ...
  // Member: goal
  firstservicepkg::action::typesupport_fastrtps_cpp::cdr_deserialize(
  ...
  size_t current_alignment)
{
  ...
  current_alignment +=
    firstservicepkg::action::typesupport_fastrtps_cpp::get_serialized_size(
  ...
  size_t current_alignment)
{
  ...
  // Member: goal
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        firstservicepkg::action::typesupport_fastrtps_cpp::max_serialized_size_Navigate_Goal(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = firstservicepkg::action::Navigate_SendGoal_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const firstservicepkg::action::Navigate_SendGoal_Request *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<firstservicepkg::action::Navigate_SendGoal_Request *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &firstservicepkg::action::typesupport_fastrtps_cpp::_Navigate_SendGoal_Request__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, firstservicepkg, action, Navigate_SendGoal_Request)() {
  return &firstservicepkg::action::typesupport_fastrtps_cpp::_Navigate_SendGoal_Request__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_firstservicepkg
cdr_serialize(
  const firstservicepkg::action::Navigate_SendGoal_Response & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: accepted
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  firstservicepkg::action::Navigate_SendGoal_Response & ros_message)
{
  // Member: accepted
  {
    uint8_t tmp;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = firstservicepkg::action::Navigate_SendGoal_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const firstservicepkg::action::Navigate_SendGoal_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<firstservicepkg::action::Navigate_SendGoal_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &firstservicepkg::action::typesupport_fastrtps_cpp::_Navigate_SendGoal_Response__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, firstservicepkg, action, Navigate_SendGoal_Response)() {
  return &firstservicepkg::action::typesupport_fastrtps_cpp::_Navigate_SendGoal_Response__handle;
}
...
{
  return &firstservicepkg::action::typesupport_fastrtps_cpp::_Navigate_SendGoal__handle;
}
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, firstservicepkg, action, Navigate_SendGoal)() {
  return &firstservicepkg::action::typesupport_fastrtps_cpp::_Navigate_SendGoal__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_firstservicepkg
cdr_serialize(
  const firstservicepkg::action::Navigate_GetResult_Request & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: goal_id
  unique_identifier_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize(
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  firstservicepkg::action::Navigate_GetResult_Request & ros_message)
{
  // Member: goal_id
  unique_identifier_msgs::msg::typesupport_fastrtps_cpp::cdr_deserialize(
    cdr, ros_message.goal_id);
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = firstservicepkg::action::Navigate_GetResult_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const firstservicepkg::action::Navigate_GetResult_Request *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<firstservicepkg::action::Navigate_GetResult_Request *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &firstservicepkg::action::typesupport_fastrtps_cpp::_Navigate_GetResult_Request__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, firstservicepkg, action, Navigate_GetResult_Request)() {
  return &firstservicepkg::action::typesupport_fastrtps_cpp::_Navigate_GetResult_Request__handle;
}
...
// forward declaration of message dependencies and their conversion functions
// functions for firstservicepkg::action::Navigate_Result already declared above
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_firstservicepkg
cdr_serialize(
  const firstservicepkg::action::Navigate_GetResult_Response & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: status
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  firstservicepkg::action::Navigate_GetResult_Response & ros_message)
{
  // Member: status
  cdr >> ros_message.status;
  ...
  size_t current_alignment)
{
  ...
  // Member: result
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        firstservicepkg::action::typesupport_fastrtps_cpp::max_serialized_size_Navigate_Result(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = firstservicepkg::action::Navigate_GetResult_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const firstservicepkg::action::Navigate_GetResult_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<firstservicepkg::action::Navigate_GetResult_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &firstservicepkg::action::typesupport_fastrtps_cpp::_Navigate_GetResult_Response__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, firstservicepkg, action, Navigate_GetResult_Response)() {
  return &firstservicepkg::action::typesupport_fastrtps_cpp::_Navigate_GetResult_Response__handle;
}
...
{
  return &firstservicepkg::action::typesupport_fastrtps_cpp::_Navigate_GetResult__handle;
}
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, firstservicepkg, action, Navigate_GetResult)() {
  return &firstservicepkg::action::typesupport_fastrtps_cpp::_Navigate_GetResult__handle;
}
...
// functions for firstservicepkg::action::Navigate_Feedback already declared above
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_firstservicepkg
cdr_serialize(
  const firstservicepkg::action::Navigate_FeedbackMessage & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: goal_id
  unique_identifier_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize(
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  firstservicepkg::action::Navigate_FeedbackMessage & ros_message)
{
  // Member: goal_id
  unique_identifier_msgs::msg::typesupport_fastrtps_cpp::cdr_deserialize(
    cdr, ros_message.goal_id);
  ...
  size_t current_alignment)
{
  ...
  // Member: feedback
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        firstservicepkg::action::typesupport_fastrtps_cpp::max_serialized_size_Navigate_Feedback(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = firstservicepkg::action::Navigate_FeedbackMessage;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const firstservicepkg::action::Navigate_FeedbackMessage *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<firstservicepkg::action::Navigate_FeedbackMessage *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &firstservicepkg::action::typesupport_fastrtps_cpp::_Navigate_FeedbackMessage__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, firstservicepkg, action, Navigate_FeedbackMessage)() {
  return &firstservicepkg::action::typesupport_fastrtps_cpp::_Navigate_FeedbackMessage__handle;
}
