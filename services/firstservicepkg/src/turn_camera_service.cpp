...
#include "/home/robot/ros_workspaces/project2/install/firstservicepkg/include/firstservicepkg/firstservicepkg/srv/turn_camera.hpp"
...
typedef firstservicepkg::srv::TurnCamera TurnCameraSrv;
...
class TurnCameraServiceNode : public rclcpp::Node 
{
	...
	private:
			...
			TurnCameraSrv::Response::SharedPtr response)
		{
			...
			std::string image_path = "/home/robot/ros_workspaces/project2/firstservicepkg/images/" + 
