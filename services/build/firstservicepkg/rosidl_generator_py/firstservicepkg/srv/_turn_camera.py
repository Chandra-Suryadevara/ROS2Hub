...
class Metaclass_TurnCamera(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'firstservicepkg.srv.TurnCamera')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from firstservicepkg.srv import _turn_camera
...
class TurnCamera(metaclass=Metaclass_TurnCamera):
    from firstservicepkg.srv._turn_camera import TurnCamera_Request as Request
    from firstservicepkg.srv._turn_camera import TurnCamera_Response as Response
