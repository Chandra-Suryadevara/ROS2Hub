...
#ifndef FIRSTSERVICEPKG__SRV__DETAIL__TURN_CAMERA__FUNCTIONS_H_
#define FIRSTSERVICEPKG__SRV__DETAIL__TURN_CAMERA__FUNCTIONS_H_
 ...
 * calls
 * firstservicepkg__srv__TurnCamera_Request__init().
...
/**
 * It calls
 * firstservicepkg__srv__TurnCamera_Request__fini()
 ...
 * firstservicepkg__srv__TurnCamera_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * firstservicepkg__srv__TurnCamera_Request__Sequence__fini()
 * on the array,
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * firstservicepkg__srv__TurnCamera_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_firstservicepkg
...
/**
 * It calls
 * firstservicepkg__srv__TurnCamera_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_firstservicepkg
...
/**
 * It allocates the memory for the array and calls
 * firstservicepkg__srv__TurnCamera_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_firstservicepkg
...
/**
 * It calls
 * firstservicepkg__srv__TurnCamera_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // FIRSTSERVICEPKG__SRV__DETAIL__TURN_CAMERA__FUNCTIONS_H_
