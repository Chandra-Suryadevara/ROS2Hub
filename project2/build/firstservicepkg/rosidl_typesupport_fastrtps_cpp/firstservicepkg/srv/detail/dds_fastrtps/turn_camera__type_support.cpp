...
#include "firstservicepkg/srv/detail/turn_camera__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = firstservicepkg::srv::TurnCamera_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const firstservicepkg::srv::TurnCamera_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<firstservicepkg::srv::TurnCamera_Request *>(
    untyped_ros_message);
...
{
  return &firstservicepkg::srv::typesupport_fastrtps_cpp::_TurnCamera_Request__handle;
}
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = firstservicepkg::srv::TurnCamera_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const firstservicepkg::srv::TurnCamera_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<firstservicepkg::srv::TurnCamera_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &firstservicepkg::srv::typesupport_fastrtps_cpp::_TurnCamera_Response__handle;
}
...
{
  return &firstservicepkg::srv::typesupport_fastrtps_cpp::_TurnCamera__handle;
}
